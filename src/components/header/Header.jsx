    ...
    <>
      <div className="mainDiv bg-[#ffffff] border-b-2 shadow-lg sticky xxxsm:py-4 lg:py-0 ">
        <div className="container">
          <header className=" grid lg:grid-cols-[30%_60%_10%] items-center justify-items-center ">
            <div className="logoArea justify-self-start">
            ...
            <div className="lightDarkBTN justify-self-end ">
